 ...
 *
 *   $Id: viewforum.php,v 1.139.2.5 2002/05/17 13:14:05 psotfx Exp $
 *
 *
 ***************************************************************************/
...
// KLB need the read_history functions
...
if ( $mark_read == 'topics' )
{
	...
	{
      // KLB 10/20/02
      // added the mark forum as read for smart read history
      //
...
$template->assign_vars(array(
	...
	'FOLDER_STICKY_IMG_BLACK' => $images['folder_sticky_black'],
	'FOLDER_STICKY_NEW_IMG' => $images['folder_sticky_new'],
	'FOLDER_ANNOUNCE_IMG' => $images['folder_announce'],
	'FOLDER_ANNOUNCE_IMG_BLACK' => $images['folder_announce_black'],
...
if( $total_topics )
{
	for($i = 0; $i < $total_topics; $i++)
	{
		...
		else
		{
			...
			if( $userdata['session_logged_in'] )
			{
				// Start KLB change for smark history tracking on 10.20.02

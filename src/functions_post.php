 ...
 *
 *   $Id: functions_post.php,v 1.9.2.7 2002/05/20 00:21:38 psotfx Exp $
 *
 *
 ***************************************************************************/
	...
	if ( $mode != 'poll_delete' )
	{
		...
		if ( $post_data['last_post'] )
		{
			if ( $post_data['first_post'] )
			{
				...
				// KLB must delete the read history if they are deleting a post
				// with only one topic (ie the origional post is being deleted)
